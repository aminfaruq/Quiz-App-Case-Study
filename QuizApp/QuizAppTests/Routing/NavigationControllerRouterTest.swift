...
final class NavigationControllerRouterTest: XCTestCase {
    ...
    func test_answerForQuestion_singleAnswer_doesNotConfiguresViewContollerWithSubmitButton() {
        let viewController = UIViewController()
        factory.stub(question: singleAnswerQuestion, with: viewController)
    ...
    func test_answerForQuestion_multipleAnswer_configuresViewContollerWithSubmitButton() {
        let viewController = UIViewController()
