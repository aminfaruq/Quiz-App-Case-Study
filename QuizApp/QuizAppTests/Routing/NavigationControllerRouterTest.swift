...
final class NavigationControllerRouterTest: XCTestCase {
    ...
    func test_routeToQuestion_singleAnswer_doesNotConfiguresViewContollerWithSubmitButton() {
        let viewController = UIViewController()
        factory.stub(question: singleAnswerQuestion, with: viewController)
    ...
    func test_routeToQuestion_multipleAnswer_configuresViewContollerWithSubmitButton() {
        let viewController = UIViewController()
    ...
    func test_routeToResult_showsResultController() {
        let viewController = UIViewController()
        let result = Result(answers: [singleAnswerQuestion: Set(["A1"])], score: 10)
        
        let secondViewController = UIViewController()
        let secondResult = Result(answers: [multipleAnswerQuestion: Set(["A2"])], score: 20)
    ...
    class ViewControllerFactoryStub: ViewControllerFactory {
        ...
        private var stubbedResults = Dictionary<Result<Question<String>, Set<String>>, UIViewController>()

        var answerCallback = Dictionary<Question<String>, (Set<String>) -> Void>()
